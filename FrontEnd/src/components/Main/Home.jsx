...
const Home = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      navigate("search", { state: { id ,searchQuery} });
    }
  };

  const handleSuggestionClick = (suggestion) => {
    setSearchQuery(suggestion.name);
    navigate("search", { state: { id , searchQuery:suggestion.name } });
  };
            ...
            <div className="col-md-4">
              ...
              >
                <div className="card-body text-center p-4">
                  ...
                  <Link to="/home/reviews" state={{ id }} className="btn btn-outline-primary mt-3" >View Reviews</Link>
                </div>
              </motion.div>
            </div>
            <div className="col-md-4">
            ...
            <div className="col-md-4">
              ...
              >
                <div className="card-body text-center p-4">
                  ...
                  <Link to="/home/companies" state={{ id }} className="btn btn-outline-primary mt-3">Explore Companies</Link>
                </div>
              </motion.div>
            </div>
          </div>
