...
import { addReview, addRole, decrementLikes, getCompanyByid, getCompanyReviews, getCompanyRoles, incrementLikes } from '../../Services/companies';
    ...
    <div className="container py-5">
        ...
        <div className="card-body">
          <div className="row align-items-center">
            ...
            <div className="col-md-10 text-center text-md-start">
              ...
              <div className="d-flex flex-wrap gap-3 text-muted justify-content-center justify-content-md-start">
      ...
      <div className="card shadow-sm">
        <div className="card-header bg-white d-flex flex-wrap gap-2 justify-content-center">
          <ul className="nav nav-tabs card-header-tabs d-flex justify-content-start w-100 flex-nowrap">
        ...
        {activeTab === 'reviews' && (
          <div>
            <div className="d-flex justify-content-between align-items-center mb-4 pe-3 ps-3">
              <h5>Reviews</h5>
              <select
            ...
            {reviews?.length === 0 ? (
              ...
              <div className="reviews-container ps-1 pe-1">
                {reviews.map((review) => (
                  <motion.div
                    key={review.id}
                    initial={{ opacity: 0, y: 20 }}
          ...
          <div>
            ...
            {(filteredRoles || filteredRoles?.length > 0) && (
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="card mb-4 bg-primary text-white shadow-sm"
              >
